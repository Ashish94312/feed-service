...
const file_proto_post_proto_rawDesc = "" +
	...
	".post.PostR\x05posts2Q\n" +
	"\vPostService\x12B\n" +
	"\x0fListPostsByUser\x12\x16.post.ListPostsRequest\x1a\x17.post.ListPostsResponseB\bZ\x06/protob\x06proto3"
...
var file_proto_post_proto_depIdxs = []int32{
	...
	2, // 2: post.PostService.ListPostsByUser:output_type -> post.ListPostsResponse
